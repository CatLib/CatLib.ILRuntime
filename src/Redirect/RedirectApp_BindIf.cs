...
namespace CatLib.ILRuntime.Redirect
{
    ...
    internal static unsafe partial class RedirectApp
    {
            ...
            CLRMethod method, bool isNewObj)
        {
            ...
            var result = App.BindIf(tService, tType, false, out bindData);
        ...
        private static StackObject* BindIf_TService_Func3_IBindData(ILIntepreter intp, StackObject* esp, IList<object> mStack,
            CLRMethod method, bool isNewObj)
        {
            var genericArguments = method.GenericArguments;
            ...
            var result = App.BindIf(tService, concrete, false, out bindData);
        ...
        private static StackObject* BindIf_TService_Func2_IBindData(ILIntepreter intp, StackObject* esp, IList<object> mStack,
            CLRMethod method, bool isNewObj)
        {
            var genericArguments = method.GenericArguments;
            if (genericArguments == null || genericArguments.Length != 1 || method.ParameterCount != 2)
            ...
            var result = App.BindIf(tService, (c, p) => concrete(p), false, out bindData);
        ...
        private static StackObject* BindIf_TService_Func1_IBindData(ILIntepreter intp, StackObject* esp, IList<object> mStack,
            CLRMethod method, bool isNewObj)
        {
            var genericArguments = method.GenericArguments;
            if (genericArguments == null || genericArguments.Length != 1 || method.ParameterCount != 2)
            ...
            var result = App.BindIf(tService, (c, p) => concrete(), false, out bindData);
