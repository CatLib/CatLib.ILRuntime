...
{
    unsafe class Game_API_Debugger_IDebugger_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Game.API.Debugger.IDebugger);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new Game.API.Debugger.IDebugger[s]);
        ...
        static StackObject* Log_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.API.Debugger.IDebugger instance_of_this_method = (Game.API.Debugger.IDebugger)typeof(Game.API.Debugger.IDebugger).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
